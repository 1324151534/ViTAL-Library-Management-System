...
INSERT INTO books (title, isbn, type, author, cover_image, location, quantity, description, published_date)
VALUES
    ('The Scarlet Letter', '978-0393927733', 'Novel', 'Nathaniel Hawthorne', 'http://localhost:5000/covers/the_scarlet_letter.jpg', 'F1-104', 5, 'The Scarlet Letter: A Romance is a work of historical fiction by American author Nathaniel Hawthorne, published in 1850. Set in Puritan Massachusetts Bay Colony during the years 1642 to 1649, it tells the story of Hester Prynne, who conceives a daughter through an affair and struggles to create a new life of repentance and dignity.', '1850-03-16'),
